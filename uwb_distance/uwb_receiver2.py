...
class UWBReceiver(Node):
    def __init__(self):
        ...
        # Change the serial ports to Bluetooth serial ports
        self.serial_port_1 = serial.Serial('/dev/rfcomm0', baudrate=115200, timeout=1)
        self.serial_port_2 = serial.Serial('/dev/rfcomm1', baudrate=115200, timeout=1)
